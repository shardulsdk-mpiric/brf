...
`/mnt/host/mpiric/<task-dir>/work/brf_protocol_fuzz_setup/scripts/run_brf_prog.sh`
folds the above into a single invocation:

```bash
/mnt/host/mpiric/<task-dir>/work/brf_protocol_fuzz_setup/scripts/run_brf_prog.sh \
    /mnt/host/mpiric/<task-dir>/work/brf_protocol_fuzz_setup/progs/pair_init.prog
```
