...
var syzkallSupport = map[string]func(*prog.Syscall, *prog.Target, string) (bool, string){
	...
	// All are unconditionally supported when CONFIG_MPTCP=y; the
	...
	"syz_mptcp_pm_remove":         alwaysSupported,
	"syz_mptcp_pm_subflow_destroy": alwaysSupported,
	"syz_mptcp_pm_set_flags":      alwaysSupported,
	"syz_mptcp_pm_kernel_add_addr": alwaysSupported,
	...
	"syz_mptcp_diag_get_one":      alwaysSupported,
	"syz_mptcp_shutdown_fuzz":     alwaysSupported,
	...
	"syz_mptcp_set_sysctl":        alwaysSupported,
	"syz_mptcp_sock_op":           alwaysSupported,
}
